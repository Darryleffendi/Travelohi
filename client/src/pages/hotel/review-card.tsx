...
export default function ReviewCard({className = "w-100 h-s60", review} : any) {
    return (
                        ...
                        <div className="flex-center justify-between">
                            ...
                            <div className="flex-center">
                                <div className="h-48p bg-col-a-transparent w-48p rounded-50 flex-center justify-center o-60 transition-2s hover-bg-col-a2 mr-1">
                                    <div className="h-40p bg-col-main w-40p rounded-50 flex-center justify-center" onClick={() => {}}>
