    ...
    return (
        <div className="w-80 flex-center flex-column justify-between wrap h-80 transition" style={{opacity:`${opacity}`}}>
            <div className="flex-center flex-column justify-between wrap">
                ...
                <p className="font-p fc-gray m-0 mb-5 fs-xxs">Please enter your details to sign in</p>
            </div>
            ...
            <a className="font-p fc-gray fs-xxs w-100 mt-1 text-right no-deco" href="https://www.nhs.uk/conditions/dementia/treatment/">Forget password?</a>
            ...
            <div className="mt-1 mb-1 w-80 flex-center justify-between">
                ...
                <p className="font-p fc-gray fs-xxs m-0 o-70">OR</p>
                <div className="overlay-line"></div>
            </div>
            ...
            <p className="font-p fs-xxs fc-red mb-1" id="error_login">{errorMessage}</p>

            <div>
                <p className="font-p fc-gray fs-xxs inline">Don't have an account? </p>
                <a className="font-h fc-black fs-xxs underline pointer" onClick={() => changePage()}>Create an account</a>
            </div>
        </div>
    )
}