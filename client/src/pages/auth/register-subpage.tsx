    ...
    return (
        <div className="w-80 flex-center flex-column justify-between wrap h-80 transition" style={{opacity:`${opacity}`}}>
            ...
            <div className="flex-center flex-column justify-between wrap">
                ...
                <p className="font-p fc-gray m-0 mb-1 fs-xxs">Please enter your details to register</p>                
            </div>

            <div className="w-100">
                <label className="font-p fc-gray fs-xxs text-left w-100" htmlFor="email">Email</label>
                <input 
            ...
            <div className="flex-center nowrap w-100 justify-between">
                <div className="w-48">
                    <label className="font-p fc-gray fs-xxs text-left w-100" htmlFor="first">First Name</label>
                    <input 
                ...
                <div className="w-48">
                    <label className="font-p fc-gray fs-xxs text-left w-100" htmlFor="last">Last Name</label>
                    <input 
            ...
            <div className="w-100">
                <label className="font-p fc-gray fs-xxs text-left w-100" htmlFor="birth">Date of Birth</label>
                <input 
            ...
            <div className="w-100">
                <label className="font-p fc-gray fs-xxs text-left w-100" htmlFor="gender">Gender</label>
                <input 
